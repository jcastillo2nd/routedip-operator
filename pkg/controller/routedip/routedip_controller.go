...
import (
	...
	routedipv1alpha1 "github.com/jcastillo2nd/routedip-operator/pkg/apis/routedip/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &routedipv1alpha1.RoutedIP{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &routedipv1alpha1.RoutedIP{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileRoutedIP) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &routedipv1alpha1.RoutedIP{}
...
func newPodForCR(cr *routedipv1alpha1.RoutedIP) *corev1.Pod {
